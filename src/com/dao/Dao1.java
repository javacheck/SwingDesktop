...
public class Dao1 {
    ...
    protected static String dbUrl = "jdbc:mysql://localhost:3306/db_library?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=utf8";// 数据库URL
    protected static String dbUser = "root";
    protected static String dbPwd = "mysql";
    ...
    public static Operater check(String name, String password) {
        ...
        ResultSet rs = Dao1.executeQuery(sql);
        try {
            while (rs.next()) {
...
//	}
    ...
    public static List selectbookserch() {
        List list=new ArrayList();
        String sql = "select *  from tb_bookInfo";
        ResultSet s = Dao1.executeQuery(sql);
        try {
            while (s.next()) {
                BookInfo bookinfo=new BookInfo();
