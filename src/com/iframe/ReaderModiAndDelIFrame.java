...
public class ReaderModiAndDelIFrame extends JInternalFrame {
    ...
    public ReaderModiAndDelIFrame() {
        ...
        Object[][] results=getFileStates(Dao1.selectReader());
    ...
    private final class DelButtonListener implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            int i=Dao1.DelReader(ISBN.getText().trim());
            if(i==1){
    ...
    class ModiButtonListener implements ActionListener {
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            int i=Dao1.UpdateReader(id, readername.getText().trim(), sex, age.getText().trim(), zjnumber.getText().trim(), Date.valueOf(date.getText().trim()), maxnumber.getText().trim(), tel.getText().trim(), Double.valueOf(keepmoney.getText().trim()), zj, zy.getText().trim(), Date.valueOf(bztime.getText().trim()), ISBN.getText().trim());
