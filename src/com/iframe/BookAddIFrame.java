...
public class BookAddIFrame extends JInternalFrame {
    ...
    class ISBNFocusListener extends FocusAdapter {
        public void focusLost(FocusEvent e){
            if(!Dao1.selectBookInfo(ISBN.getText().trim()).isEmpty()){
    ...
    class addBookActionListener implements ActionListener {		// 添加按钮的单击事件监听器
        public void actionPerformed(final ActionEvent e) {
            ...
            int i=Dao1.Insertbook(ISBNs,bookTypes, bookNames, writers, translators, publishers, java.sql.Date.valueOf(pubDates),Double.parseDouble(prices));
