...
public class newBookOrderIFrame extends JInternalFrame {
    ...
    class ButtonAddLisenter implements ActionListener{
        public void actionPerformed(final ActionEvent e) {
            ...
            if(!Dao1.selectBookOrder(ISBN.getText().trim()).isEmpty()){
            ...
            try{
                int i=Dao1.InsertBookOrder(ISBN.getText().trim(), java.sql.Date.valueOf(orderDate.getText().trim()), orderNumber.getText().trim(), operator.getText().trim(), checkAndAccept,zks);
