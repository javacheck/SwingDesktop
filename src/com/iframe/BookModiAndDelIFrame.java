...
//				int i=Dao1.Delbook(ISBNs);
//				if(i==1){
//					JOptionPane.showMessageDialog(null, "删除成功");
//					Object[][] results=getFileStates(Dao1.selectBookInfo());
//					//注释代码为使用表格模型
...
//		panel_1.add(button_2);
    ...
    class addBookActionListener implements ActionListener {
        public void actionPerformed(final ActionEvent e) {
            ...
            int i=Dao1.Updatebook(ISBNs, bookTypes, bookNames, writers, translators, publishers, Date.valueOf(pubDates), Double.parseDouble(prices));
