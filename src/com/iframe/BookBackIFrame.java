...
public class BookBackIFrame extends JInternalFrame {
    ...
    public final void add() {
        ...
        List list=Dao1.selectBookBack(readerISBNs);
    ...
    class TableListener extends MouseAdapter {
        public void mouseClicked(final MouseEvent e) {
            ...
            List list =Dao1.selectBookTypeFk(table.getValueAt(selRow, 2).toString().trim());
            for(int i=0;i<list.size();i++){
    ...
    class BookBackActionListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int i=Dao1.UpdateBookBack(bookISBNs, readerISBNs,id);
            System.out.print(i);
            if(i==1){
