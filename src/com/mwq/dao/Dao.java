...
public class Dao extends BaseDao {
	...
	public static Dao getInstance() {// ��ȡDAOʵ��
		if (dao == null)
			dao = new Dao();
		return dao;
	}
	...
	public Vector sUser() {
		return this
				.selectSomeNote("select name,sex,birthday,id_card,freeze from tb_user where freeze='����'");
	}
	...
	public Vector sUserNameOfNotFreeze() {
		return selectSomeValue("select name from tb_user where freeze='����'");
	}
