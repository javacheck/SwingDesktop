...
public class Dao {
	...
	private static String url = "jdbc:mysql://localhost:3306/db_EQ?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=utf8";// 数据库URL
	...
	public void createTable() { // 创建数据表格
		String createUserSql = "CREATE TABLE if not exists tb_users ("
				+ "ip varchar(16) primary key," + "host varchar(30),"
				+ "name varchar(20)," + "tooltip varchar(50),"
				+ "icon varchar(50))";
		String createLocationSql = "CREATE TABLE if not exists tb_location ("
